...
const implementationCode = `#include <iostream>
#include <vector>
#include <queue>
...
const toggleFeaturesBtn = document.querySelector('.toggle-features');
...
toggleFeaturesBtn.addEventListener('click', () => {
    ...
    toggleFeaturesBtn.textContent = hiddenFeatures.classList.contains('show') ? 'Show Less' : 'Show More';
});

codeButton.addEventListener('click', () => {
    codeSection.classList.toggle('hidden');
    codeButton.textContent = codeSection.classList.contains('hidden') 
        ? 'Show Implementation Code' 
        : 'Hide Implementation Code';
    
    if (!codeSection.classList.contains('hidden') && !codeElement.textContent) {
        codeElement.textContent = implementationCode;
    }
});